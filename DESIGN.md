...
## Tool UI Override (Figma Desktop Style)

For the plugin interface, override the marketing palette with a dark tool UI.
...
### Notes
- Do NOT use pure black/white contrast in tool UI
- Avoid glass effects for main layout
- Use subtle contrast between panels instead of overlays

## Visual Tone (Tool UI)

- Dark, calm, tool-like interface
- Dense layout with high information density
- Minimal spacing, efficient layout
- Subtle borders instead of shadows
- Minimal rounded corners (4–6px)
- No marketing-style cards or gradients
